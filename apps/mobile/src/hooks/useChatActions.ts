...
export const useChatActions = ({
    ...
    const handleMultiSelectSubmit = useCallback(
        ...
        [getLastAiMessage, saveUserMessage, dispatch, isGuidedFlow, submitGuidedAnswer],
    );
    ...
    const handleTextSubmit = useCallback(
        async (text: string) => {
            ...
            if (flowType === FlowType.CHATBOT) {
                ...
                const sessionId = lastMessage?.type === "ai" ? lastMessage.sessionId : undefined;
                const conversationId = lastMessage?.type === "ai" ? lastMessage.conversationId : undefined;
        ...
        [flowType, getLastAiMessage, saveUserMessage, dispatch, state.messages, sendChatbotAnswer, submitGuidedAnswer],
    );
