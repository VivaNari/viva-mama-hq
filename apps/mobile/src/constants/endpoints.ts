...
// The infant dashboard's wellbeing card. Summarises the five logs above across four
// domains; derived on read, so there is nothing to write here.
export const API_INFANT_WELLBEING = `${API_VERSION_URL}/dashboard/infant-wellbeing`;
