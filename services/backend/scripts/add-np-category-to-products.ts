/**
 * Add the NP (pregnant) category to every product in `products`, so pregnant users see
 * recommendations instead of an empty list.
 *
 * Idempotent — safe to re-run.
 *
 * Run:  npm run migrate:add-np-category-to-products
 */
...
import { migrate } from "../src/services/migration/steps/add-np-category-to-products.step";
