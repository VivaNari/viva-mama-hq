...
import aiMessageReportRouter from "./ai-message-reports/ai-message-report.route";
...
import milestoneLogRouter from "./milestone-logs/milestone-log.route";
import vaccinationLogRouter from "./vaccination-logs/vaccination-log.route";
import feedingLogRouter from "./feeding-logs/feeding-log.route";
...
router.use(aiMessageReportRouter);
router.use(supportRouter);
router.use(moodLogRouter);
router.use(growthLogRouter);
router.use(diaperLogRouter);
router.use(milestoneLogRouter);
router.use(vaccinationLogRouter);
router.use(feedingLogRouter);
